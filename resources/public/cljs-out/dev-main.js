window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=4e8e8e&fwbuild=dev"};
...
document.write('<script>goog.require("weather.core");</script>');
