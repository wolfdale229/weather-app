...
return ajax.formats.content_type_matches.call(null,content_type,p1__9985_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__9986){
...
var request = map__9987__$1;
var response_format = cljs.core.get.call(null,map__9987__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__9990){
...
var request = map__9991__$1;
var response_format = cljs.core.get.call(null,map__9991__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,(function (p1__9989_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__9989_SHARP_);
}),formats);
});
/**
