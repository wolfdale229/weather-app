...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__9818){
...
var vec_key_encode = (function (){var G__9822 = (function (){var or__4126__auto__ = vec_strategy;
...
var G__9822__$1 = (((G__9822 instanceof cljs.core.Keyword))?G__9822.fqn:null);
switch (G__9822__$1) {
case "java":
return (function (k){
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9822__$1)].join('')));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__9824){
var vec__9825 = p__9824;
var key = cljs.core.nth.call(null,vec__9825,(0),null);
var value = cljs.core.nth.call(null,vec__9825,(1),null);
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__9830){
var map__9831 = p__9830;
var map__9831__$1 = (((((!((map__9831 == null))))?(((((map__9831.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9831.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9831):map__9831);
var vec_strategy = cljs.core.get.call(null,map__9831__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
